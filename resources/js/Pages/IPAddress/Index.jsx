        ...
        <React.Fragment>
            ...
            <div className='row pb-3'>
                <div className='col-md-10'>
                    <input type='text' name='search' onChange={handleSearchInput} value={search} placeholder='Search IP by label or ip address...' className='form-control input-lg' />
                </div>
                <div className='col-md-2'>
                    <Link className='btn btn-primary btn-block' href='/ip-address'>Reset</Link>
                </div>
            </div>
